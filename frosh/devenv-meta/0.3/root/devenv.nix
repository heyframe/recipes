...

{
  ...
  services.mysql = {
    ...
    initialDatabases = lib.mkDefault [{ name = "heyframe"; }];
    ensureUsers = lib.mkDefault [
      {
        name = "heyframe";
        password = "heyframe";
        ensurePermissions = {
          "heyframe.*" = "ALL PRIVILEGES";
          "heyframe_test.*" = "ALL PRIVILEGES";
        };
      }
    ];
    settings = {
  ...
  env.DATABASE_URL = lib.mkDefault "mysql://heyframe:heyframe@127.0.0.1:3306/heyframe";
